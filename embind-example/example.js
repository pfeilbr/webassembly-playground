...
STATICTOP = STATIC_BASE + 25600;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_example_cpp() } }, { func: function() { __GLOBAL__sub_I_MyClass_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
var __GLOBAL__sub_I_MyClass_cpp = Module["__GLOBAL__sub_I_MyClass_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_MyClass_cpp"].apply(null, arguments) };
